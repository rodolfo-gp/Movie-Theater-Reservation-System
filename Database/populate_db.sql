...
INSERT INTO Provinces (province_name, sale_tax_percent, country)
VALUES 
    ('Alberta', 5.00, 'Canada'),
    ('British Columbia', 8.00, 'Canada'),
    ('Ontario', 13.00, 'Canada'),
    ('Gronk', 99.99, 'North korea');
...
VALUES 
    ...
    (1, 4, 30, 25); -- Showroom 1 in Theater 4

-- Insert data into Shows
INSERT INTO Shows (theater_id, showroom_id, movie_name, date_and_time, seat_map)
VALUES 
    (1, 1, 'Inception', '2024-12-25 18:00:00+00', JSON_ARRAY()),
    (1, 2, 'The Matrix', '2024-12-26 20:00:00+00', JSON_ARRAY()),
    (2, 1, 'Avengers: Endgame', '2024-12-27 15:30:00+00', JSON_ARRAY()),
    (4, 1, 'Boss Baby', '2024-12-24 15:30:00+00', JSON_ARRAY()),
    (4, 1, 'Boss Baby', '2024-12-25 15:30:00+00', JSON_ARRAY()),
    (4, 1, 'Boss Baby', '2024-12-26 15:30:00+00', JSON_ARRAY()),
    (4, 1, 'Boss Baby', '2024-12-27 15:30:00+00', JSON_ARRAY());
